...
public class PredictionDao extends AbstractDao<Prediction>
{
    ...
    protected Prediction createBean(Entity entity)
    {
        ...
        prediction.setGroupId(entity.getParent().getParent().getParent().getName());
        prediction.setUserId(entity.getParent().getParent().getName());
        prediction.setCouponId(entity.getParent().getName());
        prediction.setTournamentId((String) entity.getProperty(Prediction.TOURNAMENT));
        prediction.setGameId((String) entity.getProperty(Prediction.GAME));
        prediction.setHomeScore((Integer) entity.getProperty(Prediction.HOMESCORE));
        prediction.setAwayScore((Integer) entity.getProperty(Prediction.AWAYSCORE));
        return prediction;
    }
    ...
    public String create(Prediction prediction) throws DaoException
    {
        ...
        Key key = createKey(prediction.getGroupId(), prediction.getUserId(), prediction.getCouponId() ,predictionId);
    ...
    public Prediction find(String groupId, String userId, String couponId, String predictionId) throws DaoException
    {
    ...
    {
        List<Prediction> list = super.findAll(Prediction.class.getSimpleName(), null);
        return list;
    }
    ...
    public List<Prediction> findAll(String groupId)
    {
        ...
        List<Prediction> list = super.findAll(Prediction.class.getSimpleName(), key);
        return list;
    }
    ...
    public List<Prediction> findAll(String groupId, String userId, String couponId)
    {
    ...
    private Key createKey(String groupId, String userId, String couponId, String predictionId)
    {
        Builder builder = new KeyFactory.Builder(Group.class.getSimpleName(), groupId);
        builder.addChild(User.class.getSimpleName(), userId);
        builder.addChild(Coupon.class.getSimpleName(), couponId);
